# LS-DYNA Parametric Batch Run Script (Duck)
# Runs 9 cases from duck_parametric, outputs to duck_results\{case}\

$LSDYNA      = "D:\Program Files\ANSYS Inc\v231\ansys\bin\winx64\lsdyna_dp.exe"
$BASE_DIR    = "D:\system_folder\Desktop\LS-DYNA\duck_parametric"
$RESULTS_DIR = "D:\system_folder\Desktop\LS-DYNA\duck_results"
$NCPU        = 24
...
"[$startAll] Duck batch run started. Total cases: $total" | Tee-Object -FilePath $log
