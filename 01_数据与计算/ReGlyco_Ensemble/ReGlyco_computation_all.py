...
# 全局预设
# ==============================================================================
BASE_DIR    = Path(r'D:\system_folder\Desktop\Work On\01_数据与计算\ReGlyco_Ensemble')
PDB_DIR     = BASE_DIR / 'PDB'
CSV_DIR     = BASE_DIR / 'csv'
CSV_DIR.mkdir(exist_ok=True)
OLD_FOLDER  = Path(r"D:\system_folder\Desktop\Work On\01_数据与计算\ReGlyco模型_oldversion")
