...
plt.tight_layout()
_SA_FIGURE = r"D:\system_folder\Desktop\Work On\02_可视化\Sci_Adv_Figure"
...
out_sa_pdf = os.path.join(_SA_FIGURE, "PDF", "Fig_blast_chord_diagram.pdf")
out_sa_png = os.path.join(_SA_FIGURE, "PNG", "Fig_blast_chord_diagram.png")
import shutil, pathlib
pathlib.Path(os.path.join(_SA_FIGURE, "PDF")).mkdir(exist_ok=True)
pathlib.Path(os.path.join(_SA_FIGURE, "PNG")).mkdir(exist_ok=True)
