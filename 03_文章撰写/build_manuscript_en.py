...
p_s3a = spara([
    ...
    (" Fig. 4A-C first compared glycosylated and deglycosylated states within that shared structural frame. In Fig. 4A, a Ca²⁺ hotspot denotes an acidic Asp/Glu surface position with sufficiently negative electrostatic potential to favor local calcium approach. Fig. 4B then quantified how much of that carboxylate-bearing surface remained physically exposed, and Fig. 4C visualized the same shift as a whole-surface electrostatic map. Across all three species, glycosylation displaced these readouts away from the matched deglycosylated references, whereas the deglycosylated backbones themselves clustered much more closely across species. Once glycans were removed, much of the cross-species separation collapsed, indicating that most of that divergence was introduced by glycosylation rather than by the protein scaffold alone (Fig. S7).", [6, 7, 11, 12, 18, 42, 43]),
])

p_s3b = spara([
    (" Fig. 4D-G then traced that separation to glycan geometry itself. In Fig. 4D, radius of gyration reports how broadly a glycan occupies space. Fig. 4E uses end-to-end distance to show how extended the chain becomes, Fig. 4F uses glycan-protein distance to measure how far the glycan projects from the protein surface, and Fig. 4G uses minimum glycan-backbone distance to show how tightly it folds back to contact the protein.", [11, 12, 42, 43, 44, 45, 46]),
