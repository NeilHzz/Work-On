...
p_disc_future = para(
    "The present scope remains bounded. We analyzed dominant glycoforms rather than the full in vivo glycan ensemble. We also treated each species as mechanically uniform at the scale of the mean eggshell and relied on incompletely constrained uterine ionic conditions in the APBS framework. At present, available wet-lab validation systems cannot simultaneously satisfy species-specific expression of orthologous matrix proteins and precise installation of defined glycan structures at specific glycosylation sites. This constraint is compounded by biomineralization being a large, coupled reaction network rather than a single-factor assay. The next decisive tests are defined-glycoform mineralization assays, direct manipulation of OVAL glycosylation in chicken, and site-resolved validation of the same inside-out mechanical contrast, likely requiring newer experimental strategies to expand causal validation. These experiments should clarify whether the OVAL glycan state directly participates in shell mineralization or instead marks the chicken-like high-resistance state with unusual fidelity."
)
