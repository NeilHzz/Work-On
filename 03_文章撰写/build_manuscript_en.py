...
p_intro2 = spara([
    ...
    (" That same logic also appears in recent avian palaeoproteomic work. Codlin and colleagues deliberately prioritized a core eggshell set comprising c-type lectins XCA1/XCA2, OC116, albumin, BPIFB4, clusterin, lactadherin, OVAL, ovocalyxin-32, ovomucoid, and ovotransferrin because these proteins are sufficiently abundant, recurrent, and recoverable to support comparison even in degraded avian eggshell materials. Their selection is therefore informative here as well: it identifies the proteins most likely to persist as robust comparative anchors rather than the proteins most likely to vanish into specimen-specific noise.", [29, 66]),
