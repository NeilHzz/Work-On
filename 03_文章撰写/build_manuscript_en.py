...
mixed([
    ("One-way ANOVA of F_max across the nine offset positions supported a significant three-level hierarchy (p < 1.0 × 10⁻¹²): ", False, False),
    ("G. gallus", False, True),
    (" 1.117 ± 0.110 N > ", False, False),
    ("A. platyrhynchos", False, True),
    (" 0.898 ± 0.090 N > ", False, False),
    ("C. livia", False, True),
    (" 0.485 ± 0.039 N, with all pairwise differences significant (Fig. 6A). Notably, τ_max collapsed into a two-level pattern (p = 8.9 × 10⁻⁴): ", False, False),
    ("G. gallus", False, True),
