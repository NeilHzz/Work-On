...
fig_caption(
    "A 面板展示 OVAL、OC116、TRFE 和 OC17 等反复出现的蛋壳基质蛋白在鸡、鸭和鸽中的糖链类别组成，提供蛋白层面的糖基化背景。B 面板展示糖基化与 apo OVAL 结构系综在三个物种中的表面电势分布小提琴图，概括了与主图 Re-Glyco 分析中的热点数量、羧酸基可及性和 APBS 电势比较相配套的整体电势背景。"
)
