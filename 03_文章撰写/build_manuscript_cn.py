...
p_ss1_cn = smixed([
    ([('既然破壳齿本身没有提供一个能够解释这一表型差异的物种特异性差异，我们就把比较焦点转向蛋壳，并进一步基于AVONET收录的10,993个鸟类物种生态记录，把三种模型放回比较空间中（图1A）。', False, False)], [16, 22, 41]),
    ...
    ([('因此，这个对比被设计成既保留共同祖先背景，又强行把生活史差异纳入同一分析框架。', False, False)], [3, 15, 22]),
