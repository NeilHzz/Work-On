...
p_sprot_focus_cn = spara([
    ...
    ("从当前数据看，我们检测到的大多数反复出现的蛋壳基质蛋白与前人报道总体一致，说明整体蛋壳基质背景与既有研究相吻合；同时，这套数据也扩展了进入比较背景的基质蛋白范围。真正进入严格三物种结构比较子集的范围则更窄：只有 OVAL、OC116 和 TRFE 在三物种中都保留糖基化信号，而 OC17 只保留在鸡中。", []),
])
