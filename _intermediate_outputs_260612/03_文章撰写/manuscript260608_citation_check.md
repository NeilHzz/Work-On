...
Generated: 2026-06-08T00:21:55
Document: `manuscript260608.docx`
Target: Science Advances

## Summary

- Overall status: **PASS**
- In-text citation groups: 62
- Unique cited references: 67
- Reference entries: 67
- Citation/reference cross-match: **PASS**
- First-citation numbering order: **PASS**
- Reference entries missing DOI field: 67
...
- No citation/reference matching or first-citation-order errors found.

## Format Issues

- DOI missing in 67 of 67 reference entries. This is the main Science Advances compliance gap.
- In-text citation style detected: 62 parenthetical numeric groups, 0 square-bracket numeric groups.
