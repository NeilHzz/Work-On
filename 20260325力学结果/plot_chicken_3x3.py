...
颜色与 chicken_rcforc_yforce.png 一致
"""
...
# 配置
# ─────────────────────────────────────────
RESULTS_DIR = r"D:\system_folder\Desktop\LS-DYNA\chicken_results"
OUTPUT_PNG  = r"D:\system_folder\Desktop\LS-DYNA\chicken_rcforc_3x3.png"
...
def f_to_tau(f_n):
    ...
    return 1000.0 * f_n / (np.pi * D_SHELL * T_C_UM)
...
# 与 chicken_rcforc_yforce.png 中各工况颜色一致
CASE_COLORS = {
    "pos_p1_p1": "#d62728",
    "pos_p1_n1": "#1f77b4",
    "pos_n1_p1": "#2ca02c",
...
def parse_rcforc(filepath):
    ...
    for m in RE_MASTER.finditer(raw):
        ...
        if t > 23.0:
            continue
        times.append(t)
        yvals.append(float(m.group(2)))   # 鸡蛋 Y 力本身为正，无需取反
