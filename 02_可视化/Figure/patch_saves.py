...
# Replace save
t = t.replace(
    "out = r'D:\\system_folder\\Desktop\\Work On\\02_可视化\\Figure\\png\\Fig1A.png'\n",
    ""
)
t = t.replace(
...
t = t.replace(
    "out = r'D:\\system_folder\\Desktop\\Work On\\02_可视化\\Figure\\png\\Fig1B.png'\n",
    ""
)
t = t.replace(
    "plt.savefig(out, dpi=160, bbox_inches='tight')\nprint('Saved:', out)",
...
t = t.replace("import os\n", "import os\nimport sys; sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))\nfrom _save import save_fig\n", 1)
t = t.replace(
    'out_base = os.path.join(r"D:\\system_folder\\Desktop\\Work On\\02_可视化\\Figure\\png", "Fig_cafe5_expansion_contraction")\n'
...
old_save = (
    "    out_png = Path(r'D:/system_folder/Desktop/Work On/02_可视化/Figure/png') / \"Fig.Expansions and Contractions.png\"\n"
    "    out_pdf = Path(r'D:/system_folder/Desktop/Work On/02_可视化/Figure/png') / \"Fig.Expansions and Contractions.pdf\"\n"
    "    out_html = Path(r'D:/system_folder/Desktop/Work On/02_可视化/Figure/png') / \"Fig.Expansions and Contractions.html\"\n"
    "    export_pdf = True\n"
    "\n"
...
t = t.replace(
    'out_path = r"D:\\system_folder\\Desktop\\Work On\\02_可视化\\Figure\\png\\Fig3A.png"\n'
...
old_3b = (
    'out_pdf  = os.path.join(r"D:\\system_folder\\Desktop\\Work On\\02_可视化\\Figure\\png", "chord_diagram.pdf")\n'
    'out_tiff = os.path.join(r"D:\\system_folder\\Desktop\\Work On\\02_可视化\\Figure\\png", "chord_diagram.tiff")\n'
    'out_png  = os.path.join(r"D:\\system_folder\\Desktop\\Work On\\02_可视化\\Figure\\png", "chord_diagram.png")\n'
)
...
t = t.replace(
    ...
    "    for ext in ('png', 'pdf'):\n"
    "        out = os.path.join(r'D:\\system_folder\\Desktop\\Work On\\02_可视化\\Figure\\png', f'{name}.{ext}')\n"
    "        fig.savefig(out, dpi=DPI, bbox_inches='tight', facecolor='white')\n"
    "        print(f\"已保存: {out}\")",
    "def save_panel(fig, name):\n"
    "    \"\"\"Save as PNG/PDF/SVG.\"\"\"\n"
