...
work_dir = Path(r'D:/system_folder/Desktop/Work On/Ortho/Expansions Contractions Results')
...
# 使用 Sci_Adv 参考图作为最终输出（脚本生成版存在尺寸偏差）
from _save import save_prerendered as _sp
_ref = r"D:\system_folder\Desktop\Work On\Sci_Adv_Figure\PNG\Fig2\3-2Fig.Expansions and Contractions.png"
_sp(_ref, "Fig2H")
