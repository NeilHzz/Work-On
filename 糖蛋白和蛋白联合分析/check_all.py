...
DATA_DIR = r"e:\Data\Desktop\Work On\MS_DATA"
...
# ══════════════════════════════════════════════════════════════════
def check_matrix():
    file_path = r"e:\Data\Desktop\Work On\基质蛋白三物种糖链汇总.xlsx"
    try:
        xl = pd.ExcelFile(file_path)
...
# ══════════════════════════════════════════════════════════════════
def check_ortho():
    file_path = r"e:\Data\Desktop\Work On\OrthoVenn参数确定.xlsx"
    try:
        xl = pd.ExcelFile(file_path)
        print("Sheets:", xl.sheet_names)
...
def check_zhi_xiang_guan():
    file_path = r"e:\Data\Desktop\Work On\秩相关\秩相关.xlsx"
    try:
